...
const DrawerContent = (props) => {
  ...
  return (
      <View style={{flex: 1, }}>
        <DrawerContentScrollView {...props} style={{backgroundColor: '#fff', width:"70%", borderTopRightRadius: 17, borderBottomRightRadius: 17}}>
          ...
          <Drawer.Section style={{ marginTop: 19, paddingLeft:10}}>
              ...
              <DrawerItem
                  ...
                  style={{marginBottom:-5}}
                  onPress={() => {
                    props.navigation.navigate("MyChallenges");
                  }}
              />
          </Drawer.Section>
